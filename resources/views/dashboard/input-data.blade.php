...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div id="kedatangan-content" class="tab-content hidden">
        <form action="{{ route('upload.kedatangan') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        <div class="text-sm text-gray-700">
                            ...
                            <span id="kedatangan-tahunProgramText">-</span>
                            <span class="mx-2">|</span>
                            <span class="font-semibold">Total Baris:</span>
                            <span id="kedatangan-totalRowsText">0</span>
                        </div>
                        <div id="kedatangan-previewWarning" class="text-sm text-red-600 hidden"></div>
                    </div>
                </div>
            ...
            <div id="kedatangan-previewError" class="hidden bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded"></div>
        </form>
    </div>
    ...
    <div id="target-content" class="tab-content hidden">
        <div class="space-y-6">
            ...
            <div class="flex justify-end space-x-4">
                <button type="button" onclick="resetTargetUpload()" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-200">Reset</button>
                <button type="button" id="btnTargetUpload" class="px-6 py-2 kai-orange-gradient text-white rounded-lg hover:opacity-90 transition duration-200" disabled>
                    <i class="fas fa-upload mr-2"></i>Upload & Simpan
                </button>
            </div>
